...
<form method="get" action="ListItems.jsp" name="ListItem">
<input name="List Items" value="List Items" type="submit"><br> </form>
<br>
<form method="get" action="AddItem.jsp" name="AddItem">
<input name="Add Item" value="Add Item" type="submit"><br> </form>
<br>
<form method="get" action="AccountHome.jsp" name="AccountHome">
